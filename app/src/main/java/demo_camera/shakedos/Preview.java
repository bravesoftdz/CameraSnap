...
public class Preview extends ViewGroup implements SurfaceHolder.Callback, Serializable {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null != mSupportedPictureSizes) {
           // Log.e("getOptimalPreviewSize", "{" + width + "," + height + "}");
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width,
        ...
        try {
           ...
           // Log.e("mPictureSize ", "{" + mPictureSize.width + "," + mPictureSize.height + "}");
            //Log.e("mPreviewSize ", "{" + mPreviewSize.width + "," + mPreviewSize.height + "}");
            cameraSettings.setPictureSize(mPreviewSize.width, mPreviewSize.height);
            cameraFragment.getCamera().setParameters(cameraSettings);
